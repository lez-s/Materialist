...
def get_rays(directions, c2w, focal=None):
    ...
    if focal is not None:
        ...
        dxdu = torch.tensor([1.0/focal,0,0],dtype=dtype)[None,None].expand_as(directions)@R.T
        dydv = torch.tensor([0,1.0/focal,0],dtype=dtype)[None,None].expand_as(directions)@R.T
        dxdu = dxdu.view(-1,3)
        dydv = dydv.view(-1,3)
